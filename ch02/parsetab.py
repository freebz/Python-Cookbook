...
_lr_productions = [
  ...
  ('expr -> expr PLUS term','expr',3,'p_expr','ex2-19.py',303),
  ('expr -> expr MINUS term','expr',3,'p_expr','ex2-19.py',304),
  ('expr -> term','expr',1,'p_expr_term','ex2-19.py',313),
  ('term -> term TIMES factor','term',3,'p_term','ex2-19.py',319),
  ('term -> term DIVIDE factor','term',3,'p_term','ex2-19.py',320),
  ('term -> factor','term',1,'p_term_factor','ex2-19.py',329),
  ('factor -> NUM','factor',1,'p_factor','ex2-19.py',335),
  ('factor -> LPAREN expr RPAREN','factor',3,'p_factor_group','ex2-19.py',341),
]
